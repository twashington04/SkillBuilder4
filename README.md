...
- Design an FSM
- Apply a process to convert an FSM to code
- Implement an FSM in a function or class

<p style="color:red; font-size: 1.3em;">Please read the last section on submission before beginning your work.</p>
...
## 2. Designing and Implementing an FSM
...
Both FSMs from part 1 and 2 should be in a pdf document called **fsm.pdf**.  DM the fsm.pdf file to your instructor.  Await feedback before beginning to implement the code.  Submission of the implementation should be done in CodeGrade.